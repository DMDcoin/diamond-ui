...
export interface MockDiamondDaoLowMajority extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): MockDiamondDaoLowMajority;
  clone(): MockDiamondDaoLowMajority;
  methods: {
    execute(
    ...
    setMainDaoAddress(_mainDao: string): NonPayableTransactionObject<void>;
